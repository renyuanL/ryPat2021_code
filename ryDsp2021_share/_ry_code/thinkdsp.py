...
# ry Modified
def play_wave(filename="sound.wav", player= 'ffplay'): #"aplay"):
    """Plays a wave file.
...
class Wave:
    ...
    # ryModified
    def play(self, filename="sound.wav", **kwargs):
        """Plays a wave file.

        filename: string
        """
        self.write(filename)
        play_wave(filename, **kwargs)   #filename)
